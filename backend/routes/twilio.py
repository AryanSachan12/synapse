...
TWILIO_ACCOUNT_SID = os.getenv("TWILIO_ACCOUNT_SID", "AC898242a36469b45da179f61061dd6ca7")
TWILIO_AUTH_TOKEN = os.getenv("TWILIO_AUTH_TOKEN", "48fc88c75ff1e74d9e72745c78962610")
TWILIO_PHONE_NUMBER = os.getenv("TWILIO_PHONE_NUMBER", "+19207895982")
...
async def handle_incoming_call():
    ...
    start = Connect()
    start.stream(url="wss://78f3-182-79-215-75.ngrok-free.app/twilio/ws")
